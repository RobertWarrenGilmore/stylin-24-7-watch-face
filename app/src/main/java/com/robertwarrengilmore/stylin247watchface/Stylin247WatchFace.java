...
public class Stylin247WatchFace extends CanvasWatchFaceService {
  ...
  private class Engine extends CanvasWatchFaceService.Engine {
    ...
    private static final float AMBIENT_HOUR_DISC_STROKE_WIDTH = 0.005f;
    ...
    private static final float LARGE_NOTCH_WIDTH = 0.015f;
    private static final float LARGE_NOTCH_LENGTH = 0.425f;
    private static final float SMALL_NOTCH_WIDTH = 0.015f;
